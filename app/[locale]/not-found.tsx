...
import { ToolsSection } from "@/components/model-tool/tools-section"
import { getAllToolConfigs } from "@/lib/config/tool-utils";
import { getLocale } from "next-intl/server"; 
import { getTranslations } from 'next-intl/server';
import { useTranslations } from 'next-intl';

// 与 page.tsx 不同，当 Next.js 渲染 not-found.tsx 时，它认为路由匹配已经失败，因此不提供路由参数对象。
// 所以你的 params 是 undefined，导致试图解构它时报错。
export default async function NotFound() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] w-full bg-background">
      ...
      <div className="container px-6 py-12 md:py-20 mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24">
          ...
          */}
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg">
            <h1 className="text-4xl lg:text-6xl font-extrabold tracking-tight text-primary mb-4 select-none">
              {t("title")}
            </h1>
