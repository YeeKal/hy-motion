...
export function ImageDetailModal({ item, onClose, isModal = false }: ImageDetailModalProps) {
  ...
  const t = useTranslations("gallery.modal")
  ...
  const handleCopyPrompt = () => {
    ...
    toast.success(t("copied"), { description: t("copiedDesc") })
  }
  ...
  const handleShare = () => {
    ...
    const text = t("shareText", { prompt: item.prompt })
          ...
          `}>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="font-semibold text-lg">{t("prompt")}</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-muted/30 p-3 rounded-lg border border-border/50">
                  <span className="text-xs text-muted-foreground block mb-1">{t("category")}</span>
                  <span className="text-sm font-medium">{item.category}</span>
                </div>
                <div className="bg-muted/30 p-3 rounded-lg border border-border/50">
                  <span className="text-xs text-muted-foreground block mb-1">{t("aspectRatio")}</span>
